...
- Copiar archivos usando Windows
    + Abrir una sesión ssh en PuTTY. Asegúrese de activar la opción 
    + 

```bash 
cd ruta/a/directorio/local #poner la ruta del directorio local

pscp gabriel.gaona__ikiam.edu.ec@hpc.cedia.edu.ec:/home/gabriel.gaona__ikiam.edu.ec/geodata/wrf-salida/wrfout_* .
```
