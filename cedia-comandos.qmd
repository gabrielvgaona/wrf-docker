...
```bash
./link_grib.csh /home/gabriel.gaona__ikiam.edu.ec/geodata/boundary-conditions/100/fnl_*
```
...
- Copiar archivos usando GNU/Linux
...
```
- Copiar archivos usando Windows
    + Abrir una sesión ssh en PuTTY con las credenciales de usuario CEDIA
    + Abrir el `cmd` de Windows

```bash 
cd c:/ruta/carpeta/instacion/putty #poner la ruta del directorio local
pscp gabriel.gaona__ikiam.edu.ec@hpc.cedia.edu.ec:/home/gabriel.gaona__ikiam.edu.ec/geodata/wrf-salida/wrfout_* c:/ruta/a/directorio/local/.
```
